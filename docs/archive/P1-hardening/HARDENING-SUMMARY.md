...
- **`docs/archive/P1/FIRMWARE-GUIDE.md`**: раздел энергосбережения — описаны оба пути. Раздел тестирования — два отдельных сценария (graceful + ungraceful).
...
- **`docs/archive/P1/FIRMWARE-GUIDE.md`**: таблица ACL — убрана строка Subscribe. Добавлено явное указание: "Устройство не должно подписываться — подписка будет отклонена ACL." Пример `mosquitto_sub` заменён на admin-credentials.
...
- **`docs/archive/P1/FIRMWARE-GUIDE.md`**: добавлено описание формата пароля в раздел credentials.
...
| `docs/archive/P1/FIRMWARE-GUIDE.md` | H1, H2, H3 | Docs: ACL, тестирование offline, формат пароля |
