...
| [docs/DESIGN-SYSTEM.md](docs/DESIGN-SYSTEM.md) | Дизайн-система Снежок (палитра, шрифт) |
...
# HTTP_PORT=8080
# MQTT_PORT=1883
# DEVICE_OFFLINE_TIMEOUT_BATTERY_SEC=2100
# DEVICE_OFFLINE_TIMEOUT_MAINS_SEC=300
# TELEGRAM_BOT_TOKEN=...
```
